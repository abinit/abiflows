# -*- coding: utf-8 -*-
#
# abiflows documentation build configuration file, created by
# sphinx-quickstart on Fri Feb  8 10:59:20 2013.
#
...
#sys.path.insert(0, os.path.abspath('..'))
sys.path.insert(0, os.path.abspath('../abiflows'))
#sys.path.insert(0, os.path.abspath('../..'))
